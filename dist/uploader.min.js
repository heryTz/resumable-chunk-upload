(() => {
  ...
  var Uploader = class {
    ...
    getUploadStatus = async () => {
      return new Promise((resolve, reject) => {
        ...
        if (!Number.isInteger(this.chunkCount) || !this.uploadStatusUrl || !this.uploadUrl)
          reject(new UploadError(UploadError.INVALID_CONFIGURATION));
  ...
  __publicField(UploadError, "INVALID_CONFIGURATION", "INVALID_CONFIGURATION");
